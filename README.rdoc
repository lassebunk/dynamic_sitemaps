...
If the sitemap has more than 50.000 urls – or whatever you set it to using per_page – the plugin will automatically split the sitemap into smaller chunks and generate a sitemap index, also specified at http://sitemaps.org.
...
After installing you need to create a sitemap route in <code>config/routes.rb</code>:
...
4. Type in sitemap.xml (or whatever you have called it) – no domain is needed as this is locked to your current website
